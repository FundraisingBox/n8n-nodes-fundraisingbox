...
export const communicationCreateDescription: INodeProperties[] = [
	{
		...
		default: 0,
		description: 'ID of the person to associate this communication with',
	},
	{
		displayName: 'Message',
		name: 'html_message',
		...
		options: [
			{
				...
				type: 'dateTime',
				default: '',
				description: 'Date and time of the communication. Defaults to now.',
			},
			{
